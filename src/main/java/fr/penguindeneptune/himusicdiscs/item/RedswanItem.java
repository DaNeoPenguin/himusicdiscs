...
public class RedswanItem extends MusicdiscsModElements.ModElement {
	@ObjectHolder("musicdiscs:redswan")
	public static final Item block = null;

	public RedswanItem(MusicdiscsModElements instance) {
		super(instance, 10);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, MusicdiscsModElements.sounds.get(new ResourceLocation("musicdiscs:redswan")),
					new Item.Properties().group(CreativeTabItemGroup.tab).maxStackSize(1).rarity(Rarity.RARE));
			setRegistryName("redswan");
		}
